...
public class NotificationUtils extends ContextWrapper {
    ...
    private void createNotificationChannel() {
        ...
        NotificationChannel channel = new NotificationChannel(Common.Notification.CHANNEL_ID,
                Common.Notification.CHANNEL_NAME,
    ...
    public static NotificationCompat.Builder getNotificationCompat(String title, String content, int icon) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            builder = new NotificationCompat.Builder(BaseApplication.getInstance(), Common.Notification.CHANNEL_ID);
        } else {
    ...
    public static Notification.Builder getChannelNotification(String title, String content, int icon) {
        Notification.Builder builder = new Notification.Builder(BaseApplication.getInstance(),
                Common.Notification.CHANNEL_ID);
