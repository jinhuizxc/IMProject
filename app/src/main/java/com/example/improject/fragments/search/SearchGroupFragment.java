package com.example.improject.fragments.search;
...
import com.example.improject.activity.SearchActivity;
...
public class SearchGroupFragment extends PresenterFragment<SearchContract.Presenter>
    ...
    class ViewHolder extends RecyclerAdapter.ViewHolder<GroupCard> {
        ...
        void onJoinClick() {
            // 进入创建者的个人界面
            PersonalActivity.startActivity(getContext(), mData.getOwnerId());
        }
    }
